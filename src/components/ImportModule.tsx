...
import { validateAndProcessImport } from '../utils/importUtils';
...
export function ImportModule({ onImportSales, onRefreshData }: ImportModuleProps) {
  ...
  const handleFileImport = async (file: File) => {
    ...
    try {
      ...
      const processedPreview = validateAndProcessImport(rawData);
              ...
              <div className="flex space-x-4">
                ...
                >
                  {importing ? (
                    ...
                    <span>Confirmer l'Import ({preview.data.length} lignes - {formatCurrency(preview.totals.overall.revenue)})</span>
                  )}
                </button>
